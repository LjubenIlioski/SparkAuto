...
namespace SparkAuto.Pages.Users
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet(int productPage = 1, string searchEmail = null, string searchName = null,
            string searchPhone = null)
        {
            ...
            UsersListVM.PagingInfo = new PagingInfo
            {
                ...
                ItemsPerPege = SD.PaginationUsersPageSize,
                TotalItems = count,
